...
// Initialize GoogleGenAI outside the component with proper configuration
...
<body class="p-[10px]">
  <h1 class="text-[30px] font-[700]">Welcome to WebSmith</h1>
</body>
</html>
    `
  );
...
6. **UI Sections** (as per user request):  
   ...
   - **Footer** with the text: "Made with WebSmith"  
  ...
  return (
    <>
      ...
      <div className="container">
        <h3 className='text-[30px] font-[700]'>Create beautiful websites with <span className='bg-gradient-to-br from-violet-400  to-purple-600 bg-clip-text text-transparent'>WebSmith</span></h3>
